...
export const fileTooLarge = (msg = 'File too large') => new AppError(413, 'FILE_TOO_LARGE', msg);
export const csvError = (msg, details) => new AppError(422, 'CSV_PARSE_ERROR', msg, details);
